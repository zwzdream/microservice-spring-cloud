...
import com.itmuch.cloud.feign.impl.FeignClientFallback;
 ...
 */
@FeignClient(name="microservice-provider-user",configuration = ConfigurationFeign.class,fallback =FeignClientFallback.class)
